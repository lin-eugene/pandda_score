...
def record_labels_per_batch(batch: Dict[str, Any],
                                    test_pred_probability: torch.Tensor,
    ...
    pred_probability = test_pred_probability.tolist()
...
def scoring_loop(model: torch.nn.Module,
    ...
    with torch.inference_mode():
        ...
        for sample in dataloader:
            ...
            output_labels += record_labels_per_batch(sample, debug_pred_probability, debug_pred_labels)
